# Algoritmo genético para el problema del SAT
import math
import random
...
def algoritmo_genetico():
    ...
    while not fin:
        ...
        for i in range( math.floor(len(poblacion) / 2)):
...
if __name__ == "__main__":
    ...
    print("Función de adaptacion: " + str(mejor_gen[1]))